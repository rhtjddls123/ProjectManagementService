    ...
    <>
      <Sheet open={trigger}>
        ...
        >
          ...
          <SheetClose className='absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none'>
          ...
          {trigger && (
            <div
              onClick={triggerToggle}
              className={
                'fixed w-[80%] inset-x-[20%] inset-0 z-40 data-[state=closed]:animate-out data-[state=closed]:fade-out-0'
              }
            ></div>
          )}
        </SheetContent>
